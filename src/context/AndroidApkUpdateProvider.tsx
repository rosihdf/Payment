...
export const useAndroidApkUpdate = (): AndroidApkUpdateContextValue => {
  const ctx = useContext(AndroidApkUpdateContext);
  if (ctx == null) {
    throw new Error('useAndroidApkUpdate must be used within AndroidApkUpdateProvider');
  }
  return ctx;
};

export const useAndroidApkUpdateOptional = (): AndroidApkUpdateContextValue | null =>
  useContext(AndroidApkUpdateContext);

type AndroidApkUpdateProviderProps = {
  children: ReactNode;
};

export const AndroidApkUpdateProvider = ({ children }: AndroidApkUpdateProviderProps) => {
  ...
  return <AndroidApkUpdateContext.Provider value={value}>{children}</AndroidApkUpdateContext.Provider>;
};
