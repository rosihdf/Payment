...
export function createClassicCommissionRules(): CommissionRule[] {
  return [
    baseRule({
      id: 'commission_rule_classic_terminal_acq_long',
      commissionPlanVersionId: DEFAULT_COMMISSION_PLAN_VERSION_CLASSIC_ID,
      name: 'Terminal + ACQ (>=36 Monate)',
      internalDescription: 'PPT klassisch – Terminal + ACQ bei Laufzeit >= 36 Monate (300 €)',
      contractConfiguration: 'terminal_acq_long_term',
      fixedAmountCents: 30000,
      combinable: false,
    }),
    baseRule({
      id: 'commission_rule_classic_terminal_short',
      commissionPlanVersionId: DEFAULT_COMMISSION_PLAN_VERSION_CLASSIC_ID,
      name: 'Terminalvertrag (<36 Monate)',
      internalDescription: 'PPT klassisch – Terminalvertrag unter 36 Monate (200 €)',
      contractConfiguration: 'terminal_short_term',
    ...
    baseRule({
      ...
      commissionPlanVersionId: DEFAULT_COMMISSION_PLAN_VERSION_CLASSIC_ID,
      name: 'ACQ-only',
      internalDescription: 'PPT klassisch – eigenständiger ACQ-Vertrag (150 €)',
      contractConfiguration: 'acq_only',
...
export function createVariableFixedCommissionRules(): CommissionRule[] {
  return [
    baseRule({
      id: 'commission_rule_variable_terminal_acq_long',
    ...
    baseRule({
      id: 'commission_rule_variable_terminal_short',
      commissionPlanVersionId: DEFAULT_COMMISSION_PLAN_VERSION_VARIABLE_MODEL_1_ID,
      name: 'Terminalvertrag (<36 Monate)',
    ...
    baseRule({
      ...
      commissionPlanVersionId: DEFAULT_COMMISSION_PLAN_VERSION_VARIABLE_MODEL_1_ID,
      name: 'ACQ-only',
      internalDescription: 'PPT variabel – feste Provision 100 € (ACQ-only)',
      contractConfiguration: 'acq_only',
      fixedAmountCents: 10000,
      combinable: false,
    }),
