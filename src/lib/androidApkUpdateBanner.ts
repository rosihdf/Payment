...
export const notifyAndroidApkSnoozeReset = (): void => {
  if (typeof window === 'undefined') return;
  window.dispatchEvent(new CustomEvent(ANDROID_APK_SNOOZE_RESET_EVENT));
};

export const readSnoozedAndroidApkVersionCode = (): number | null => {
...
export const writeSnoozedAndroidApkVersionCode = (versionCode: number): void => {
...
export const evaluateAndroidApkUpdateBannerVisibility = (
...
export const shouldShowAndroidApkUpdateBanner = (i: AndroidApkUpdateBannerGateInput): boolean =>
  evaluateAndroidApkUpdateBannerVisibility(i).shouldShow;
