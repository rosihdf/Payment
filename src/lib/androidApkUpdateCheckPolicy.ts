...
const bypassesAutoCheckCooldown = (reason: AndroidApkUpdateCheckReason): boolean =>
  reason === 'manual' || reason === 'info_mount' || reason === 'initial';

export const shouldRunAndroidApkUpdateCheck = (
