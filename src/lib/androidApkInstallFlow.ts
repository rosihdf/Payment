...
/** Nutzer-/UI-Text zu Fehler aus APK-Download oder Paketinstaller (Wartung, Payment-Branding). */
  ...
  if (typeof e === 'object' && e !== null && 'message' in e) {
    ...
    if (msg.includes(INSTALL_SOURCE_BLOCKED_MESSAGE_PREFIX)) {
      ...
      return cleaned.length > 0
        ? cleaned
        : 'Falls Android blockiert, erlauben Sie die Installation aus dieser Quelle für AMRtech Payment in den Android-Einstellungen.';
    }
...
/**
 * Interner Ablauf: APK laden → App-Cache → Paketinstaller (1:1 Wartung).
 */
